<template>
  <div class="top">
    <div class="flex justify-between">
      <div class="flex">
        ...
        <!-- 其他异常 -->
        <span class="ml-10px fw-500 color-#333 text-16px mt-4px">{{ otherLabel }}</span>
      </div>
      <div class="flex">
  ...
  <el-table
    ...
    <el-table-column prop="errorInfo" label="异常描述"  align="center" />
  </el-table>
...
const handleExport = () => {
  exportToExcel(
    ...
    [
      ...
      { header: "学号", key: "studentCode" },
      { header: "学校", key: "schoolName" },
      { header: "班级", key: "className" },
    ],
    props.otherLabel || "其他异常列表",
  );
};
