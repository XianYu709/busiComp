  ...
  <div class="top">
    <div class="flex justify-between">
      <div class="flex">
        ...
        <!-- 应交 -->
        <span class="ml-10px fw-500 color-#333 text-16px mt-4px">{{ shouldLabel }}</span>
      </div>
      <div class="flex cursor-pointer" @click="handleExport">
...
const handleExport = () => {
  exportToExcel(
    ...
    [
      ...
      { header: "解析时间", key: "createTime" },
    ],
    props.shouldLabel || "应交列表",
  )
};
