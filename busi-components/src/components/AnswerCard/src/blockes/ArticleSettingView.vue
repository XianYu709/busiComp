<template>
  <el-form label-width="70px">
    ...
    <el-form-item label="题目边框" label-width="70px" labelPosition="left">
      <el-radio-group v-model="model.questionBorder">
        <el-radio :value="false">否</el-radio>
        <el-radio :value="true">是</el-radio>
      </el-radio-group>
    </el-form-item>

<!--    FIX: （20260417 潘旭东）showQuestionDesc的值默认为false，但是页面上隐藏该item  -->
<!--    <el-form-item label="是否展示题目描述" label-width="150px" labelPosition="left">-->
<!--      <el-radio-group v-model="model.showQuestionDesc">-->
<!--        <el-radio :value="false">否</el-radio>-->
<!--        <el-radio :value="true">是</el-radio>-->
<!--      </el-radio-group>-->
<!--    </el-form-item>-->
