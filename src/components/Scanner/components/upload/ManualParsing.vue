  ...
  <div class="h-screen flex flex-col bg-gray-50 overflow-hidden">
    ...
    <div
      ...
      <div class="flex items-center gap-4">
        ...
        <span class="font-bold text-gray-800">人工解析</span>
      </div>

      <div class="flex gap-3">
        <el-button-group class="mr-25">
        ...
        <el-button type="" size="default">变更为缺考</el-button>
        <el-button type="primary" size="default" @click="openAssignDrawer">变更考生</el-button>
      </div>
    </div>
      ...
      <el-drawer
        ...
        <template #title>
          <div class="flex items-center justify-between w-full pr-4">
            <div>
              <span class="text-lg font-medium">为当前答题卡分配考生</span>
            </div>

            <el-button-group>
              <el-button class="" size="default">上一份</el-button>
              <el-button class="" size="default">下一份</el-button>
            </el-button-group>
          </div>
        </template>
        ...
        <el-table
          ...
          <el-table-column prop="examNo" label="考号" align="center" min-width="120" />
          <el-table-column prop="name" label="姓名" align="center" min-width="80" />
          <el-table-column prop="class" label="班级" align="center" min-width="80" />
          <el-table-column
            prop="status"
            label="状态"
            align="center"
        ...
        <div class="mt-3 flex justify-between items-center">
          ...
          <div class="flex items-center gap-2">
            <span class="text-sm text-gray-500">10条/页</span>
            <el-pagination
