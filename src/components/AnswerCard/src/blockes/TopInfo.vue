  ...
  <div class="pt-10px">
    <div class="group relative w-full">
      <div
        ...
        <!--   <div>
          <el-button @click="$emit('delete')">删除示例</el-button>
        </div> -->
      </div>
      ...
      <div class="flex justify-between">
        ...
        <div v-if="rightSetting.idNumberType == 'tiantu'" class="flex" ref="idBoxRef">
          ...
          <FillBox :hover-setting="true" v-model="fillId"></FillBox>
        </div>
      </div>
      ...
      <div
        ...
        <div class="py-2 pl-2">[ &nbsp;&nbsp;&nbsp;]</div>
      </div>
      <div class="border" v-if="!isTight && rightSetting.showAbsentFlag" ref="flagBoxRef">
        <div class="absent-l">此栏考生禁填</div>
        <div class="absent-r">
          缺考标记：[ &nbsp;&nbsp;&nbsp;]&nbsp; 缺考考生由监考员填涂考号，并用2B铅笔填涂缺考标记
        </div>
      </div>
    </div>
...
watch(
  () => rightSetting.value.idNumberType,
  () => {
    nextTick(() => {
      getBoxPositon();
    });
