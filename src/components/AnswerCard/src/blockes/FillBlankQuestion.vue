    ...
    <div class="group relative w-full">
      ...
      <div>
        ...
        <div
          ...
          ">
          <RightBox
            v-if="route.query?.reviewMethod == '2' && rightSetting.fillBlankMergeReview == true"
            :totalScore="
...
const renderSegment = (item: any) => {
  ...
  const prefixWidthHtml = `<span style="display:inline-block;width:${prefixHtml.length}ch;"></span>`;
      ...
      html += `
        <span
          style="
            ...
            margin-right:10px;
            vertical-align:bottom;
            width: calc(${rate * 100}% - ${rate * 100 - 10}px);
          "
        >
